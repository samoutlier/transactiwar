...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-md p-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <?php if (!$isOwnProfile): ?>
                <a href="/transfer?to=<?= (int)$user['id'] ?>" class="bg-indigo-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-indigo-700 transition">Send Money</a>
            <?php endif; ?>
        </div>
        ...
        <div class="mt-6">
            <a href="/search" class="text-indigo-600 text-sm hover:underline">&larr; Back to search</a>
        </div>
    </div>
</div>
